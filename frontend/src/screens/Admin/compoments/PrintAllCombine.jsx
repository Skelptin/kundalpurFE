...
function PrintAllCombine({ setopendashboard, setshowreciept,  handleClose50,
  datasend, }) {
  ...
  return (
    <>
      ...
      <div className="button_div_print_download">
          <button onClick={() => handleClose50()}>Back</button>
        ...
        <div className="super_main_divsss" ref={componentRef}>
          <div>
            ...
            {isData?.details && isData?.details.length > 1 ? (
              <>
                {isData?.details &&
                isData?.details[0]?.itemType ? (
                  <>
...
export default PrintAllCombine;
