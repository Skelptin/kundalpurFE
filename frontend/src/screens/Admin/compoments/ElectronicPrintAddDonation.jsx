...
function ElectronicPrintAddDonation({ setopendashboard, setshowreciept }) {
    ...
    <>
      <div style={{ paddingLeft: '4rem', paddingRight: '4rem' }}>
        <div className="button_div_print_download10">
          <button onClick={() => navigation('/admin-panel/donation')}>Back</button>
...
export default ElectronicPrintAddDonation;
