...
const UpdatePO = ({ updatedata, closeEdit, openEdit }) => {
    ...
    useEffect(() => {
        ...
        getUOM();
        if (updatedata) {
            setPurchaseReq(updatedata?.purchaseRequisitonNo)
            setPONo(updatedata?.purchaseOrderNo)
            ...
            setContactNoStaff(updatedata?.contactPerson)
            setContactPerson(updatedata?.contactName)
            setRemark(updatedata?.remark)
            setdbItems(updatedata?.purchaseOrderList)
