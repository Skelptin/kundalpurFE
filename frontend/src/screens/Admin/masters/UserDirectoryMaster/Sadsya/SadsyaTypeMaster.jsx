...
const CommitteeMaster = ({ setopendashboard }) => {
  ...
  const handleClose4 = () => {
    setOpen3(false);
    serverInstance(`/admin/delete-sadsyaType?id=${deleteId}`, 'delete').then((res) => {
                ...
                <>
                  {(rowsPerPage > 0
                    ...
                    >
                      ...
                      <TableCell>{row?.sadsyaType_hi}</TableCell>
                      <TableCell>{row?.sadsyaType_en}</TableCell>
...
export default CommitteeMaster;
