...
function UDAddForm({ setOpen, updatedata }) {
    ...
    const [itemHi, setItemHi] = useState('')
    ...
    const handlesubmit = async () => {
        try {
            ...
            const res = await axios.put(`${backendApiUrl}admin/edit-item`, data);
    ...
    useEffect(() => {
        if (updatedata) {
            setItemCode(updatedata?.itemCode);
            setItemHi(updatedata?.itemNameHindi);
            setItem(updatedata?.itemNameEnglish);
        }
    }, []);
                ...
                <div className="cash-donation-container-innser10">
                    ...
                    <div className="inner-input-div2">
                        ...
                        <ReactTransliterate
                            ...
                            onChange={(e) => setItemHi(e.target.value)}
                            lang="hi"
                        />
                    </div>
