...
function UDAddForm({ setOpen, updatedata }) {
    ...
    const handlesubmit = async () => {
        try {
            ...
            const res = await axios.put(`${backendApiUrl}admin/edit-supplierName`, data);
    ...
    useEffect(() => {
        if (updatedata) {
            ...
            setSupNameEnglish(updatedata?.supplierName_hi);
            setSupNameHindi(updatedata?.supplierName_en);
        }
    }, []);
                ...
                <div className="cash-donation-container-innser10">
                    ...
                    <div className="inner-input-div2">
                        ...
                        <ReactTransliterate
                            ...
                            required
                            value={supNameHindi}
                            onChangeText={(supNameHindi) => {
                                setSupNameHindi(supNameHindi);
                            }}
