...
import TRAddForm from './TRAddForm';
import TRUpdate from './TRUpdate'
...
const TRMaster = ({ setopendashboard }) => {
  ...
  const handleClose4 = () => {
    setOpen3(false);
    serverInstance(`admin/delete-trustType?id=${deleteId}`, 'delete').then((res) => {
        ...
        <Fade in={open}>
          <Box sx={style}>
            <div>
              ...
              <TRAddForm setOpen={handleClose} updatedata={updatedata} />
            </div>
          </Box>
        </Fade>
      </Modal>
        ...
        <Fade in={open1}>
          <Box sx={style}>
            <div>
              ...
              <TRUpdate setOpen={handleClose1} updatedata={updatedata} />
            </div>
          </Box>
        </Fade>
      </Modal>
