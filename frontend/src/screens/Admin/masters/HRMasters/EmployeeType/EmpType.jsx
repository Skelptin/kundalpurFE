...
const EmpType = ({ setopendashboard }) => {
  ...
  const handleClose4 = () => {
    setOpen3(false);
    serverInstance(`admin/delete-employeeType?id=${deleteId}`, 'delete').then((res) => {
              ...
              {isData &&
                isData?.map((item, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell>{item?.employeeType_code}</TableCell>
                    <TableCell>{item?.employeeType_hi}</TableCell>
                    <TableCell>{item?.employeeType_en}</TableCell>
                    <TableCell>
                      <Tooltip title="Edit">
                        <img
