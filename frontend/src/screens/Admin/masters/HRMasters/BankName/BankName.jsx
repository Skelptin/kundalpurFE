...
const BankName = ({ setopendashboard }) => {
  ...
  const handleClose4 = () => {
    setOpen3(false);
    serverInstance(`admin/delete-bankName?id=${deleteId}`, 'delete').then((res) => {
        ...
        <Fade in={open1}>
          <Box sx={style}>
            <div>
              ...
              <UpdateBank setOpen={handleClose1} updatedata={updatedata} />
