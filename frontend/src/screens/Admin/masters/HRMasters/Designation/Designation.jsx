...
const Designation = ({ setopendashboard }) => {
  ...
  const handleClose4 = () => {
    setOpen3(false);
    serverInstance(`admin/delete-designation?id=${deleteId}`, 'delete').then((res) => {
      ...
      >
        <Fade in={open1}>
          <Box sx={style}>
            ...
            <UpdateDesignation setOpen={handleClose1} updatedata={updatedata}/>
          </Box>
        </Fade>
      </Modal>
      <div>
            ...
            {isData && (rowsPerPage > 0
              ...
              : isData
                  ...
                  <TableRow key={index}>
                    ...
                    <TableCell>{item?.hi_designation}</TableCell>
                    <TableCell>{item?.en_designation}</TableCell>
