...
import Addboli from './Addboli';
import UpdateBoli from './UpdateBoli';
                    ...
                    {(rowsPerPage > 0
                      ...
                      >
                        ...
                        <TableCell>
                          ...
                          <Tooltip title="Boli edit">
                            <img
                              style={{ width: '20px' }}
                              onClick={() => handleOpen12(row)}
                              src={Edit}
                              alt=" Print"
                            />
                          </Tooltip>

                          <Tooltip title="Enter Payement">
                            <img
                              style={{ width: '20px' }}
                              onClick={() => handleOpen11(row)}
                              src={payimg}
                              alt=" Print"
                            />
                          </Tooltip>
