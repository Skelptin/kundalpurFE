...
import PrintBoli from '../Boli/PrintBoli';
import PaymentBoli from '../Boli/PaymentBoli';
...
const PendingBoli = ({ setopendashboard }) => {
  let filterData;
  ...
  const getall_donation = () => {
    ...
    setvoucherto('');
    setsearchvalue('');
    serverInstance('boli/getPending-boli', 'get').then((res) => {
