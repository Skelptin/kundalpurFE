...
import AddboliGroup from './AddboliGroup';
...
const BoliGroup = ({ setopendashboard }) => {
  let filterData;
    ...
    try {
      if (searchvalue) {
        ...
        const res = await axios.get(
          `${backendApiUrl}boli/search-boliGroup?search=${searchvalue}`,
        );
        ...
        serverInstance(
          `boli/get-boliGroup?fromDate=${datefrom}&toDate=${dateto}`,
          'get',
        ).then((res) => {
          if (res.status) {
  ...
  const handleClose2 = () => {
    setOpen2(false);
    serverInstance(`boli/delete-boliGroup?id=${deleteId}`, 'delete').then(
      (res) => {
        if (res.status === true) {
    ...
    <>
      ...
      >
        <Fade in={open13}>
          ...
          >
            <Update
              handleClose={handleClose13}
              themeColor="#7037ad"
              handleOpen4={handleOpen13}
              setopendashboard={setopendashboard}
              receiptNo={receiptNo}
              donationTypes={donationTypes}
              updateData={updata}
      ...
      <div className="dashboarddiv" style={{ marginLeft: '1rem' }}>
        ...
        <div style={{ paddingLeft: '3rem' }}>
          <div
            ...
            style={{ paddingLeft: '5rem', paddingRight: '1.3rem' }}
          >
