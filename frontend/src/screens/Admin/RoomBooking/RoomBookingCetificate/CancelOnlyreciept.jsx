...
const CancelOnlyreciept = ({ setopendashboard }) => {
  ...
  const handlesubmit = async () => {
    navigation('/admin-panel/room/CancelOnlyprint', {
      state: {
        data: isData,
      },
    });
  ...
  var checkindate = moment(isData?.date).format('DD');
                    ...
                    >
                      <div className="maxxin_room_receipt_innear">
                        <div style={{ backgroundColor: 'red' }}>
                          <p className="yadda_text lineheight">कैंसिल रसीद</p>
                        </div>
...
export default CancelOnlyreciept;
