...
const CheckoutReceipt = ({ setopendashboard }) => {
  ...
  const shareReceipt = () => {
    serverInstance(
      `room/checkout-certificate?booking_id=${isData?.booking_id}`,
      'get',
    ).then((res) => { });
  };
    ...
    <>
      {`${Object.keys(date).length > 0}` && (
        <div>
          ...
          >
            ...
            >
              Share on whatsaap and Checkout
            </button>
          </div>
          ...
          <div style={{ padding: '1rem' }} ref={componentRef}>
            <div className="main-certificate" id="receipt">
              ...
              <div className="note_text">
                <p>
                  नोट : रूम चेक आउट समय 24 घंटे के पश्चात दूसरे दिन का चार्ज
                  मान्य होगा। रूम केन्सिल एवं बदलने का समय 1 घंटे रहेगा ।
                </p>
              </div>
              <div className="main-certificatenote">
                ...
                <p>
                  3. आवासीय इकायईयों के सभी कमरों में गैस/स्टोव/सिगड़ी/इंडक्शन
                  का प्रयोग वर्जित है ।
                </p>
                <p>
                  4. अनजान व्यक्तियों से किसी भी प्रकार की खाद्य सामग्री ना
                  खरीदे अधिकृत दुकानों से ही लेवें ।
                </p>
                <p>
                ...
                <p>
                  6. यात्रीगण को जारी की गई सामग्री खोने/टूटफूट होने की स्थिति
                  में नियमानुसार राशि जमा करानी होगी ।
                </p>
                <p>
                  7. आवास (कमरा) खाली करते समय धर्मशाला इंचार्ज (चौकीदार) के
                  हस्ताक्षर पर्ची पर लाने का कष्ट करें, उसके पश्चात ही चेकआउट
                  होगा ।
                </p>
                <p>
                  8. यात्रीगण अपने अमूल्य सुझाव श्री दिगम्बर जैन सिद्धक्षेत्र
                  कुण्डलगिरि, कुण्डलपुर के अध्यक्ष/महामंत्री को लिखित में
                ...
                <p>
                  10. आवासीय इकाइयों में पॉलीथिन का उपयोग ना करें, साफ-सफाई
                  रखें, आवश्यक्तानुसार जल, बिजली एवं अन्य उपकरणों का उपयोग करें,
                  उपयोग ना होने पर उपकरणों को बंद कर व्यवस्थाओं में सहयोग प्रदान
                  करें ।
                </p>
                <p>
                  11. क्षेत्र पर एवं धर्मशाला/आवास में धर्म विरूद्ध कार्य होते
                  पाए जाने पर आवास/कमरा तुरंत खाली करवाने हेतु प्रबंधक को पूर्ण
                  अधिकार हैं, यह पवित्र धार्मिक/सिद्धक्षेत्र है इसकी
                  मर्यादा/पवित्रता बनाए रखना हम सभी का कर्त्तव्य एवं अधिकर है ।s
                </p>
                <p>
                  12. आवासीय इकाइयों (कमरा) में यदि किसी भी प्रकार के
                  नल/बिजली/सफाई आदि संबंधित कोई भी समस्या हो तो कमरा बुक करवाने
                  के 1 घंटे के अंदर ही कार्यालय में जाकर चेंज करा लेवें अन्यथा 1
                  घंटे बाद कमरा चेंज (बदला) नहीं जावेगा एवं नियमानुसार सहयोग
                  राशि देय होगी ।
                </p>
                <p>
                  13. रूम चेकआउट का समय चेकिन के समय से 24 घंटे तक है उसके
                  पश्चात दूसरे दिन की सहयोग राशि मान्य होगी, रूम बदलने (शिफ्ट)
                  का समय 1 घंटे तक ही रहेगा ।
                </p>
                <div className="absolute_text">
                  <p>
                    क्षेत्र में हो रहे निर्माण कार्य की जानकारी आप कार्यालय से
                    प्राप्त । कर सकते है एवं दान राशि क्षेत्र के बैंक खातों में
                    भी जमा करा सकते है।
                  </p>
                </div>
              </div>
              <div className="reciept-footer-style">
                <p>
                  मोबाईल : +91-7771834880, +91-7771835891 पर कार्यदिवस में
                  संपर्क कर सकते हैं।
                </p>
              </div>
            </div>
      ...
      {/* <div>
        ...
        >
          <button onClick={() => navigation(-1)}>Back</button>
          <button onClick={() => down()}>Download</button>
          <button onClick={() => handlesubmit()} style={{ width: '17rem' }}>
            Share on whatsaap and Checkout
          </button>
        </div>
        <div style={{ height: '10rem' }} />
