...
const ReceiptAllcheckout = ({ setopendashboard }) => {
  ...
  const handlesubmit = () => {
    navigation('/admin-panel/room/HistoryAllCheckoutPrint', {
      state: {
        checkoutdata: isData,
      },
    });
                        ...
                        <div>
                          <table className="table_ddd">
                            <tbody>
                                    ...
                                    backgroundColor:
                                      ...
                                      isData?.reduce((acc, item) => {
                                        ...
                                        : isData &&
                                          isData?.reduce((acc, item) => {
                                            return (
                                              acc + parseInt(item?.roomAmount)
                                            );
                                          }, 0) -
                                            isData?.reduce((acc, item) => {
                                              return (
                                                acc +
                                                parseInt(item?.advanceAmount)
                                              );
                                            }, 0) >
                                            0
                                        ? 'green'
                              ...
                              <tr>
                                <td className="table_tddd lineheight10">
                                  {isData && isData[0]?.dharmasalaName}
                                </td>
                                <td className="table_tddd lineheight10">
...
export default ReceiptAllcheckout;
