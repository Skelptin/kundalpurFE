...
const Onlinecheckouthistort = ({ setopendashboard }) => {
  ...
  const handlesubmit = async () => {
    navigation('/admin-panel/room/Onlinecheckouthistoryprint', {
      state: {
        data: isData,
      },
    });
    ...
    <>
      <div>
        ...
        >
          ...
          <button onClick={() => handlesubmit()}> Print Checkout</button>
        </div>
...
export default Onlinecheckouthistort;
