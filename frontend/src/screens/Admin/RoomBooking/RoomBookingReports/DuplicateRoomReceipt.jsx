...
const DuplicateRoomReceipt = ({ setopendashboard }) => {
  ...
  const getall_donation = () => {
    ...
    if (optionss === 'Currently Stay') {
      serverInstance('admin/checkDoubleReceipt-roomBooking', 'get').then(
        (res) => {
          if (res?.data) {
            setloader(false);
    ...
    if (optionss === 'History') {
      serverInstance('admin/checkDoubleReceipt-roomBooking', 'post').then(
        (res) => {
          console.log(res);
          if (res.data) {
            setloader(false);
  ...
  const filterdata = async (e) => {
    ...
    try {
      serverInstance(
        `admin/checkDoubleReceipt-roomBooking?fromDate=${datefrom}&toDate=${dateto}`,
        'get',
      ).then((res) => {
        if (res?.data) {
...
export default DuplicateRoomReceipt;
