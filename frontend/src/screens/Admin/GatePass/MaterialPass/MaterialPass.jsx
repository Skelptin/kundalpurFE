...
import LineItem from './ListItem/LineItem';
...
const VehiclePass = ({ setopendashboard }) => {
  let filterData;
  ...
  const getMaterialList = () => {
    serverInstance('vehicle/get-material', 'get').then((res) => {
      if (res) {
        if (res?.status) {
          console.log('gate material is ', res?.data);
          setisData(res?.data);
          // isDataDummy(res?.data);
        }
      }
    });
  };
        ...
        <div>
          ...
          >
            <div className="search-inner-div-reports">
              ...
              <div className="Center_main_dic_filetr">
                <label>&nbsp;</label>
                <button onClick={() => handleOpen()}>Gate In</button>
              </div>
