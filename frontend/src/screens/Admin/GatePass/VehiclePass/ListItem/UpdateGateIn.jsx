...
const UpdateGateIn = ({
  ...
  console.log('update data is from vehicle', updateData);
  ...
  useEffect(() => {
    ...
    if (updateData) {
      ...
      //   setVehicletype(updateData?.VehicleType);
      setVehiclename(updateData?.VehicleName);
      setVehicleno(updateData?.VehicleNo);
      setremarks(updateData?.Remark);
