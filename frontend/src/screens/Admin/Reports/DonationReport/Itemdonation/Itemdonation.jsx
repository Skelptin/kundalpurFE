...
import PrintContent from '../../../compoments/PrintElecModalContent';
import ModalElecReceipt from '../../../Reciept/ModalElecReceipt';
    ...
    <>
      ...
      <div style={{ marginLeft: '5rem', marginRight: '1rem' }}>
        ...
        <div className="table-div-maain">
          <Table
            sx={{ minWidth: 650, width: '100%', fontSize: '5px' }}
            ...
            <TableHead style={{ background: '#FFEEE0' }}>
              <TableRow>
                ...
                <TableCell>
                  ...
                  <i
                    style={{ marginLeft: '0rem' }}
                    onClick={() => sortDataItemtype('elecItemDetails')}
                    class={`fa fa-sort`}
                  />
                </TableCell>
                <TableCell>
                  ...
                  <i
                    style={{ marginLeft: '0rem' }}
                    onClick={() => sortDataSize('elecItemDetails')}
                    class={`fa fa-sort`}
                  />
                </TableCell>
                ...
                <TableCell>
                  ...
                  <i
                    style={{ marginLeft: '0rem' }}
                    onClick={() => sortRDataQuantity('elecItemDetails')}
                    class={`fa fa-sort`}
                  />
                </TableCell>
                <TableCell>
