...
const Electornic = ({ setopendashboard }) => {
  ...
  const sortDataBank = (key) => {
    ...
    setisData(
      [...isData].sort((a, b) => {
        if (a[key][0]?.BankName < b[key][0]?.BankName) {
          return direction === 'ascending' ? -1 : 1;
        }
        if (a[key][0]?.BankName > b[key][0]?.BankName) {
          return direction === 'ascending' ? 1 : -1;
  ...
  const sortDataTransation = (key) => {
    ...
    setisData(
      [...isData].sort((a, b) => {
        if (a[key][0]?.transactionNo < b[key][0]?.transactionNo) {
          return direction === 'ascending' ? -1 : 1;
        }
        if (a[key][0]?.transactionNo > b[key][0]?.transactionNo) {
          return direction === 'ascending' ? 1 : -1;
            ...
            <TableHead style={{ background: '#FFEEE0' }}>
              <TableRow>
                ...
                <TableCell>
                  ...
                  <i
                    style={{ marginLeft: '0rem' }}
                    onClick={() => sortDataBank('elecItemDetails')}
                    class={`fa fa-sort`}
                  />
                </TableCell>
                <TableCell>
                  ...
                  <i
                    style={{ marginLeft: '0rem' }}
                    onClick={() => sortDataTransation('elecItemDetails')}
                    class={`fa fa-sort`}
                  />
                </TableCell>
                <TableCell>
                    ...
                    >
                      ...
                      <TableCell>
                        <div style={{ width: '4rem',wordWrap: "break-word" }}>
                          <p style={{fontWeight:300}}>{row.elecItemDetails[0]?.transactionNo}</p>
                        </div>
                      </TableCell>
