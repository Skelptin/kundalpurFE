					...
					<div className="mainContainer" style={{ marginLeft: "1rem", }} id="capture">
						<div className="row" style={{marginTop:"3rem" }}>
							<div className="col-11">
								...
								<h6
									...
									style={{ borderBottom: "none", color:"#23395d" , textAlign: "center", fontWeight: "bold", width: "100%" }}
								>
						...
						<div style={{ marginTop: "1%" }}>
							<div className="row">
								...
								<div className="col-4">
									<div className="dotts-main" style={{ marginTop: "0.50rem" }}>
										<div className="withou-dotts_class_3" style={{ color:"#23395d",}}>
											दिनांक : </div><div className="dotts-class_4"> <h6 style={{color:"#23395d",}}>
											{purchaseVoucher && purchaseVoucher.bill_date && moment(purchaseVoucher.bill_date).format("DD-MM-YYYY")}</h6>
										</div>
									</div>
								</div>
							</div>
						</div>
						<div className="vouprint_0" style={{ width: "100%" }}>
							<div className="vouprint_0_1" style={{ color:"#23395d",}}>
							...
							<div className="vouprintsss_2">
									...
									<div className="row" style={{ width: "100%" }} >
											...
											<div className="form-group">
												<div className="dotts-main">
													<div className="withou-dotts_class_5" style={{ color:"#23395d",}}>
														...
														<h6 style={{color:"#23395d",}}> &nbsp;&nbsp;
															{purchaseVoucher &&
																purchaseVoucher.purchase_order &&
																purchaseVoucher?.purchase_order?.branch?.branch_name}
														</h6>														
													</div>
												</div>
											</div>
											...
											<div className="form-group">
												<div className="dotts-main">
													<div className="withou-dotts_class_1" style={{ color:"#23395d",}}>
														बिल क्रमांक </div><div className="dotts-class_2"> <h6 style={{color:"#23395d",}}> {purchaseVoucher && purchaseVoucher.invoice_no}</h6>
													</div>
												</div>
											</div>
										</div>
										<div className="col-5">
											<div className="form-group">
												<div className="dotts-main">
													<div className="withou-dotts_class_3" style={{ color:"#23395d",}}>
														दिनांक : </div><div className="dotts-class_4">
															<h6 style={{color:"#23395d",}}>
											...
											<div className="form-group">
												<div className="dotts-main">
													<div className="withou-dotts_class_v" style={{ color:"#23395d",}}>
														...
														<h6 style={{color:"#23395d",}}> {purchaseVoucher && purchaseVoucher.remark}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (&nbsp;{purchaseVoucher && purchaseVoucher.tally_data?.branch?.department_name}&nbsp;)</h6>
													</div>
												</div>
											</div>
										</div>
								...
								<div className="vouprint_4">
									<div className="col-12">
										<label style={{ background: "#D3D3D3", width: "100%", height: "100%",color:"#23395d", textAlign: "center" }}><spen style={{ fontWeight:"bold",color:"#23395d",}}>राशि  (रू.)</spen></label>
									</div>
									<h6 style={{ textAlign: "center", marginTop: "4rem",fontWeight: "bold", color:"#23395d", }}>{purchaseVoucher && purchaseVoucher.payment_amount}</h6>
								</div>
							</div>
						</div>
						<div className="row_1"  >
