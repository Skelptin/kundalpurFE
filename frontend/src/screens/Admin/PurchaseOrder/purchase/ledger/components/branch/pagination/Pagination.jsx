...
export default function Pagination()
{
	...
	var total = pv && pv.PvBranchList && pv.PvBranchList.count;

	var no_of_page = total ? Math.ceil(total / pv.rowPerPage) : 0;
				...
				<div class="col-md-6 mt-4 ms-auto" style={{ marginRight: "10rem" }}>
					<ul class="pagination" style={{ color: "black", fontSize: "12px" }}>
						...
						{pageLink.map((link, index) => (
							<li class={`page-item page-link ${ pv.currentPage === link.key
