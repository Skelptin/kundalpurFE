              ...
              <div className="print">
                <div className="main_po">
                  <div className="main_po_1">
                    ...
                    <div className="main_po_3">GSTIN :23AADTP8230A1Z1</div>
                  </div>
                  <div className="printheader">
                    ...
                    <p>
                      <h4
                        align="center"
                        style={{ fontWeight: "bold", marginRight: "8rem" }}
                      >
                        प्रतिभामंडल न्यास
                      </h4>
                      <h5 style={{ fontWeight: "bold" }}>
                        प्रतिभास्थली ज्ञानोदय विद्यापीठ परिसर , तिलवाराघाट ,
                        जबलपुर ( म. प्र. )-482003,<h5> फोन नंबर- +91 8819088922</h5>
                      </h5>
                    </p>
                  </div>
                    ...
                    <div className="printbody_1">
                      <div className="printbody_2">
                        ...
                        <h6 style={{ marginLeft: "1rem" }}>
                          <h6>
                            Po code :- <spen>{purchaseOrder?.po_code}</spen>
                          </h6>
                          Branch :-
                          <span>
                            {/* {purchaseOrder &&
                      ...
                      {purchaseOrder &&
                        ...
                        purchaseOrder.order_list.map((item, index) => (
                          <tr>
                            <td>{index + 1}</td>
                            <td>
                              {moment(purchaseOrder.created_at).format(
                                "DD-MM-YYYY"
                              )}
                            </td>
                            <td>
                              {moment(purchaseOrder.exp_arr_date).format(
                                "DD-MM-YYYY"
                              )}
                            </td>
                            {/* <td>{item.id}</td> */}
                            ...
                            <td>
                              {item.item_master?.item_unit?.unit
                                ? item.item_master?.item_unit?.unit
                                : item.finish_product?.fp_unit?.unit}
                            </td>
                            <td>{item.price}</td>
                            <td>
                              {item.item_master?.item_gst?.gst_percent
                                ? item.item_master?.item_gst?.gst_percent
                                : item.finish_product?.fp_gst?.gst_percent}
                            </td>
                            <td>{item.discount_percent}</td>
                            <td>
                              {item?.return_amount ? item?.return_amount : 0.0}
                            </td>
                          </tr>
                        ))}
                      <tr>
                        ...
                        <td>{purchaseOrder?.return_grand_total}</td>
                      </tr>
                    </tbody>
                  </table>
                  {/* <div className="terms">
                    ...
                    <h6>
                      *In case of delay in supply of goods, following T&C will
                      be applicable*
                    </h6>

                    <ol style={{ marginLeft: "-3rem" }}>
                      <li>
                        Supplier has to ensure the supply best quatity of goods
                        as per original samples otherwise goods not be accepted.
                      </li>
                      <li>Delivery time within D.O.D</li>
                      <li>Need testing pass raw material..</li>
                      <li>
                        Quote our P.O number in your invoice, packing list,
                        Challan & Other documents.
                      </li>
                      <li>
                        This Order is subject to approval of pre-production
                        samples.
                      </li>
                      <li>
                        All disputes are subject to jabalpur jurisdiction.
                      </li>
                      <li>
                        If the above T&C are not fulfilled then there will be
                        penalty of 10% on undelivered goods.
                      </li>
                    </ol>
                  </div> */}
                  <br /> <br />
