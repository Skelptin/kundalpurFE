                      ...
                      {purchaseOrder &&
                        ...
                        purchaseOrder.order_list.map((item, index) => (
                          <tr>
                            ...
                            <td>
                              ...
                              {item?.item_return?.length > 0
                                ? item?.item_return.map((x, i) => {
                                    // console.log("item?.item_return", x);
                                    return (
                                      <>
                                        <tr>
                                          <td>
                            ...
                            <td>
                              {item?.return_amount ? item?.return_amount : 0}
                            </td>
                          </tr>
                        ))}
                      <tr>
