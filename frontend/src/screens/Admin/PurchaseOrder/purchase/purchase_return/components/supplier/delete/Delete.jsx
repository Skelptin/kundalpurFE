...
import { deletePurchaseOrder, deletePurchaseSupplierOrder, fetchPurchaseSupplierOrderList } from "../../../../../../reducers/purchase/purchase_order/PurchaseOrderSlice";
...
export const Delete = (props) => {
	...
	const Delete = (data) => {
		dispatch(deletePurchaseSupplierOrder({ data, toast })).then((res) =>
		...
		<>
			...
			<Modal show={show} onHide={handleClose} animation={false}>
				<Formik
					initialValues={{
						id: props?.po?.id,
						supplier:props.po?.supplier?.supplier_name
					}}
