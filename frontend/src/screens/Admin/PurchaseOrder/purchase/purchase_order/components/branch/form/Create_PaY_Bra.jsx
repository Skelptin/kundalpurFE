...
import { fetchPurchaseBranchOrderList, getactualBalanceAmount, purchaseOrderSelector } from "../../../../../../reducers/purchase/purchase_order/PurchaseOrderSlice";
import { fetchLedgerBranchList } from "../../../../../../reducers/purchase/ledger/LedgerSlice";
...
export const Create_PaY_Bra = (props) => {
  ...
  const create = (data) => {
    ...
    if (parseFloat(data.invoice_amount) > parseFloat(data.total_amount)) {
      ...
      formData.append("frieght", data.frieght);
      formData.append("transport", data.transport);
      formData.append("actual_balance_amount", actualBalanceAmount?.actual_balance_amount);
        ...
        <Formik
          initialValues={{
            ...
            actual_balance_amount: actualBalanceAmount?.actual_balance_amount
              ? parseFloat(actualBalanceAmount?.actual_balance_amount)
              : 0,
            // contact_no: "",
            // city_name: "",
                            ...
                            >
                              ...
                              {Config.Payment_Choice.map((choice, index) => (
                                <option
                                  value={choice}
                                  disabled={
                                    newactualGrandTotal === 0 ? index === 0 : "" || newactualGrandTotal > 0
                                      ? index === 1
                                      : ""
                                  }
                                >
                        ...
                        <div className="col-md-6">
                          <div class="form-group">
                            ...
                            <input
                              ...
                              type="text"
                              class="form-control"
                              value={props?.po?.branch?.branch_name}
                              readonly
                            />
                          </div>
                        </div>
