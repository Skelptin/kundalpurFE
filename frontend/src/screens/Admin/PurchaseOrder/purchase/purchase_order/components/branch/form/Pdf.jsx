...
import {fetchPoDownloadPDF } from "../../../../../../reducers/document/DocumentSlice";
...
export default function Pdf() {
	...
	const downloaddPDF = (type) => {
		if (to && from) {
			...
			dispatch(fetchPoDownloadPDF({data: data })).then(pdf => {
				if (pdf?.payload.data) {
