...
import { updatePurchaseSupplierOrder } from "../../../../../../reducers/purchase/purchase_order/PurchaseOrderSlice";
...
export const Update_PO = forwardRef((props, ref) => {
  ...
  const searchItems = async (id, index, p) => {
    ...
    p.setFieldValue(`order_list.${index}.item_master`, null);
  };
  ...
  const update = (payload) => {
    if (payload.order_list.find((x) => x.item_master == null)) {
      ...
      dispatch(updatePurchaseSupplierOrder({ payload, toast })).then(() =>
        dispatch(
          fetchPurchaseSupplierOrderSearchList({
            offset: 0,
            limit: 15,
